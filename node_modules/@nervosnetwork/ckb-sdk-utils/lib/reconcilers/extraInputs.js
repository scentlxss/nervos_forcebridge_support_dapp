...
const calculateTransactionFee_1 = tslib_1.__importDefault(require("../calculateTransactionFee"));
const sizes_1 = require("../sizes");
const exceptions_1 = require("../exceptions");
exports.extraInputs = (params) => {
    ...
    const fee = jsbi_1.default.BigInt(calculateTransactionFee_1.default(`0x${sizes_1.getTransactionSize(params.tx).toString(16)}`, `0x${feeRate.toString(16)}`));
